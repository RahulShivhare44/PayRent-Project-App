...
function Home(props) {
  ...
  return (
    <View style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', height: height * (1) }}>
      <View style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: width * (0.85), marginTop: height * 0.19, backgroundColor: '#f5fffa', elevation: 15, margin: 5, borderBottomEndRadius: 20, borderBottomStartRadius: 20, borderTopEndRadius: 20, borderTopStartRadius: 20, padding: 10 }}>
        <View >
          <Image
        ...
        <View
          ...
          <View
            ...
            <View style={{ width: 170, height: 57, borderRightWidth: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
              <Icon name="schedule" style={{ marginRight: 5, marginLeft: -15 }} size={20} />
            ...
            <View style={{ width: 155, height: 57, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
              <Icon name="schedule" size={20} style={{ marginRight: 5, marginLeft: -20 }} />
          ...
          <View style={{
            ...
            <View style={{ width: 170, height: 57, borderRightWidth: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
              <Icon name="schedule" size={20} style={{ marginRight: 10, marginLeft: -20 }} />
            ...
            <View style={{ width: 150, height: 57, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
              <Icon name="schedule" size={20} style={{ marginRight: 10, marginLeft: -20 }} />
        ...
        <AppButton btnWidth={0.7} onPress={() => handleSearch()} buttonText={'Search'} bgColor="#27ae60" />
